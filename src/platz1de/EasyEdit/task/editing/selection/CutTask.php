...
class CutTask extends ExecutableTask
{
	...
	{
		CopyTask::from($this->getOwner(), $this->world, new AdditionalDataManager(false, true), $this->selection, $this->position, $this->selection->getPos1()->multiply(-1))->execute();
		SetTask::from($this->getOwner(), $this->world, new AdditionalDataManager(true, true), $this->selection, $this->position, new Vector3(0, 0, 0), new StaticBlock([], PatternArgumentData::create()->setRealBlock(0)))->execute();
	}
