...
class Noise3DTask extends SelectionEditTask
{
	...
	{
		TaskInputData::fromTask(self::from($selection->getPlayer(), $place->getWorld()->getFolderName(), new AdditionalDataManager(true, true), $selection, $place->asVector3(), new Vector3(0, 0, 0), $octaves, $persistence, $expansion, $threshold));
	}
