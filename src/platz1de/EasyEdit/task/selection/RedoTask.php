...
class RedoTask extends EditTask
{
	...
	public static function queue(BlockListSelection $selection): void
	{
		...
		WorkerAdapter::queue(new QueuedEditTask($selection, new Pattern([], []), new Position(0, 0, 0, $selection->getLevel()), self::class, new AdditionalDataManager(["edit" => true]), new Vector3()));
	}
