...
class HollowCylinderCommand extends EasyEditCommand
{
	...
	public function process(Player $player, array $args): void
	{
		...
		SetTask::queue(new HollowCylinder($player->getName(), $player->getWorld()->getFolderName(), $player->asVector3()->floor(), (int) $args[0], (int) $args[1], (int) ($args[3] ?? 1)), $pattern, $player->getPosition());
	}
}