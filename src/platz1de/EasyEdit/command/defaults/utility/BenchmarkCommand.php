...
class BenchmarkCommand extends SimpleFlagArgumentCommand
{
	...
	{
		return [
			"keep" => new SingularCommandFlag("keep", [], "k") //intentionally not documented, as it provides no benefits other than simplified debugging
		];
	}
}