...
class HollowCylinderPiece extends CylinderPiece
{
	 ...
	 * @param int          $thickness
	 */
	public function __construct(string $player, string $world = "", ?Vector3 $pos1 = null, ?Vector3 $min = null, ?Vector3 $max = null, int $radius = 0, int $height = 0, int $thickness = 1)
	{
		parent::__construct($player, $world, $pos1, $min, $max, $radius, $height);
