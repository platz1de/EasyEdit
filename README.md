...
| //brush sphere \[radius] \[pattern] [gravity]<br>//brush smooth \[radius]<br>//brush naturalize \[radius] \[topBlock] \[middleBlock] \[bottomBlock]<br>//brush cylinder \[radius] \[height] \[pattern] [gravity] | Create a new Brush         | easyedit.brush <br> (To use: easyedit.edit) | //br                                                             |
